    ...
    static contextType = PedidoContext
     ...
     render() {
         ...
         return (
            ...
            await  BluetoothEscposPrinter.printText("          LOS MISERABLES ", {heigthtimes:3});
            await  BluetoothEscposPrinter.printText("\r\n",{});
            await  BluetoothEscposPrinter.printText("Pedidos WhatsApp: 5583826027", {});
            await  BluetoothEscposPrinter.printText("\r\n",{});
            await  BluetoothEscposPrinter.printPic(img64, {width: 180, left: 100});
            await  BluetoothEscposPrinter.printText("\r\n",{});
